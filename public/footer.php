<footer class="footer">
    ...
    <div class="row">
      <div class="span4">
        <div class="widget">
          ...
          <address>
        <strong>Nombre Compañia</strong><br>
        Trinidad esquina Independencia<br>
        Coronel Boogado, Paraguay<br>
        <abbr title="Phone">P:</abbr> (0985) 000 000
        </address>

          <address>
        <strong>Contact us</strong><br>
        <a href="mailto:#">ps2carlos@gmail.com</a>
        </address>
        </div>
      </div>
      <div class="span4">
  ...
  <div class="verybottom">
    <div class="container">
      <div class="row">
        <div class="span6">
              <div class="footer-copyright">&copy; <?= site_info('titulo') ?> todos los derechos reservados. <?= site_info('direccion') ?>.</div>
        </div>
        <div class="span6">
