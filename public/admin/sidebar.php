<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><span>AranduMk</span>Admin</a>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
  <div class="profile-sidebar">
    ...
    <div class="profile-usertitle">
      <div class="profile-usertitle-name"><?php echo ($row['nombre']); ?></div>
  ...
  <ul class="nav menu">
    ...
    <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
      ...
      <ul class="children collapse" id="sub-item-1">
        <li><a class="" href="page-contenido.php">
          <span class="fa fa-arrow-right">&nbsp;</span> Ingresar Contenido
        </a></li>
        <li><a class="" href="page-consultar.php">
          <span class="fa fa-arrow-right">&nbsp;</span> Consultar Contenido
        </a></li>
        <li><a class="" href="page-configuracion.php">
          <span class="fa fa-arrow-right">&nbsp;</span> Configuración
        </a></li>
      </ul>
    </li>
  ...
  <!--	<li><a href="widgets.html"><em class="fa fa-calendar">&nbsp;</em> Widgets</a></li>
    ...
    <li><a href="../../php/logout.php"><em class="fa fa-power-off">&nbsp;</em> Cerrar Sesion</a></li>
  </ul>
</div><!--/.sidebar-->
